...
function draw_trial_stimuli(canvas, context, phase, progress = 0) {
    ...
    const circle_radius = deg_to_pixels(0.5, params.viewing_distance_cm, params.monitor_width_cm, canvas.width);
    const cue_radius = deg_to_pixels(1.0, params.viewing_distance_cm, params.monitor_width_cm, canvas.width);
