...
function draw_trial_stimuli(canvas, context, phase, progress = 0) {
    ...
    const circle_radius = deg_to_pixels(1.0, params.viewing_distance_cm, params.monitor_width_cm, screen_width); // circle radius
    const cue_radius = deg_to_pixels(2.0, params.viewing_distance_cm, params.monitor_width_cm, screen_width);
    const circle_offset_x = deg_to_pixels(6.0, params.viewing_distance_cm, params.monitor_width_cm, screen_width); // horizontal offset
    const circle_offset_y = deg_to_pixels(1.1, params.viewing_distance_cm, params.monitor_width_cm, screen_width);
    const fixation_size = deg_to_pixels(0.5, params.viewing_distance_cm, params.monitor_width_cm, screen_width);
